  ...
  return (
    <html lang="en" className={inter.className}>
      <head>
        ...
        <meta name="apple-mobile-web-app-title" content="Frank And Sons Exterminators" />
        <meta name="mobile-web-app-capable" content="yes" />
        <meta name="application-name" content="Frank And Sons Exterminators" />
        ...
        <meta name="google-site-verification" content="gtI0rbt_ktDfSiqixlXrwlJnq5yjSn2SpygOlEmJ6ME" />
